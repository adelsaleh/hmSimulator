...
for i=0:1:50
    u=ffreaddata(["plots/ny-modon-plotted-" num2str(i)]);
    ffpdeplot(p,b,t,'VhSeq', vh,... 
                    ...
                    'XLim', [-10,10],...
                    'YLim', [-9,10]);
    xlabel('Expected dipole vortex behavior.', 'fontweight', 'bold');
    img = print('-RGBImage');
    imwrite(img, '~/adelsaleh.github.io/images/ny-modon-plotted.gif', 'DelayTime', 0.1, 'Compression', 'bzip', 'WriteMode', 'Append');
end
